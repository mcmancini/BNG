...
fcn_plt_map <- function(data, 
                        ...
                        border_col,
                        direction){
  eng_border <- st_read("C:/Users/rmc1d22/Documents/GitHub/BNG/R_scripts/Functions/england_full_clipped_2.shp") 
...
fcn_continuous_plot <- function(plot_data, 
  ...
  plot <- ggplot() +
    geom_sf(data = eng_border_buff, fill = border_col, colour = border_col, lwd = 1) +
    geom_sf(data = eng_border, fill = 'grey85',  colour = 'grey85', lwd = 1) +
    geom_sf(data = df,
    ...
    scale_color_viridis(legend_title,
                        ...
                        discrete = FALSE,
                        direction = direction) +
    geom_sf(data = eng_border, fill = NA,  colour = 'grey85', lwd = 20) +
    ggtitle(plot_title) +
    theme_bw() +
