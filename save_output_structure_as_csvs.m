...
%  ==========================
clear
load('Output/new_ordering/per_hectare/local_bio_offset.mat')
load('Output/new_ordering/per_hectare/max_bio_offset.mat')
load('Output/new_ordering/per_hectare/max_es_rec_ghg_only_offset.mat')
load('Output/new_ordering/per_hectare/max_equity_offset.mat')
load('Output/new_ordering/per_hectare/min_cost_offset.mat')
...
writetable(max_bio_offset_es_outs,"D:\Documents\GitHub\BNG\Output\baseline_2031_urbanisation\Offset_outputs\new_ordering\per_hectare\max_bio_offset_es_outs.csv");

% Max. ecosystem services 
% -----------------------
max_es_offset_benefits = max_es_rec_ghg_only_offset.benefits;
max_es_offset_benefits.new2kid = max_es_rec_ghg_only_offset.new2kid;
max_es_offset_benefits.hectares_chg = max_es_rec_ghg_only_offset.hectares_chg; 
writetable(max_es_offset_benefits,"D:\Documents\GitHub\BNG\Output\baseline_2031_urbanisation\Offset_outputs\new_ordering\per_hectare\max_es_offset_benefits.csv");

max_es_offset_costs = max_es_rec_ghg_only_offset.costs;
max_es_offset_costs.new2kid = max_es_rec_ghg_only_offset.new2kid;
max_es_offset_costs.hectares_chg = max_es_rec_ghg_only_offset.hectares_chg; 
writetable(max_es_offset_costs,"D:\Documents\GitHub\BNG\Output\baseline_2031_urbanisation\Offset_outputs\new_ordering\per_hectare\max_es_offset_costs.csv");

max_es_offset_env_outs = max_es_rec_ghg_only_offset.env_outs;
max_es_offset_env_outs.new2kid = max_es_rec_ghg_only_offset.new2kid;
max_es_offset_env_outs.hectares_chg = max_es_rec_ghg_only_offset.hectares_chg; 
writetable(max_es_offset_env_outs,"D:\Documents\GitHub\BNG\Output\baseline_2031_urbanisation\Offset_outputs\new_ordering\per_hectare\max_es_offset_env_outs.csv");

max_es_offset_es_outs = max_es_rec_ghg_only_offset.es_outs;
max_es_offset_es_outs.new2kid = max_es_rec_ghg_only_offset.new2kid;
max_es_offset_es_outs.hectares_chg = max_es_rec_ghg_only_offset.hectares_chg; 
writetable(max_es_offset_es_outs,"D:\Documents\GitHub\BNG\Output\baseline_2031_urbanisation\Offset_outputs\new_ordering\per_hectare\max_es_offset_es_outs.csv");
